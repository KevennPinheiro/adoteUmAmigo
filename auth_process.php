<?php
  ...
  if($type === "register") {
    ...
    if($name && $lastname && $email && $password && $whatsapp && $cidade && $estado) {
      if (strlen($whatsapp) == 15) {
          ...
          // Enviar uma msg de erro, número do WhatsApp inválido
          $message->setMessage("Digite um número válido.", "error", "back");
      }
  } else {
