<?php
  ...
  // Pets que o usuário adicionou
  $userPets = $petDao->getPetsByUserId($id);
  ...
  <div id="main-container" class="container-fluid">
    <div class="col-md-8 offset-md-2">
      <div class="row profile-container">
        ...
        <div class="col-md-12 added-pets-container">
          <h3>Pets que enviou:</h3>
          <div class="pets-container">
            <?php foreach($userPets as $Pet): ?>
              <?php require("templates/pet_card.php"); ?>
            <?php endforeach; ?>
            <?php if(count($userPets) === 0): ?>
              <p class="empty-list">O usuário ainda não enviou nenhum pet.</p>
            <?php endif; ?>
          </div>
        </div>
      </div>
